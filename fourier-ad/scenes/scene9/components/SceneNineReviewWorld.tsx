...
const agents = [
  { label: "Search", cursor: searchCursorUrl, accent: TEAL, x: 375, y: 237 },
  { label: "Video", cursor: videoCursorUrl, accent: GOLD, x: 1_285, y: 237 },
  { label: "Script", cursor: scriptCursorUrl, accent: CORAL, x: 1_285, y: 627 },
] as const;
