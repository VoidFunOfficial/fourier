...
const agents = [
  { label: "Search", cursor: searchCursorUrl, accent: "#78c8c1", x: 375, y: 237 },
  { label: "Video", cursor: videoCursorUrl, accent: "#9c90d4", x: 1285, y: 237 },
  { label: "Review", cursor: reviewCursorUrl, accent: "#e2bd76", x: 375, y: 627 },
] as const;
...
function MacDocument() {
  return (
    ...
    >
      ...
      >
        <MacDocumentTitlebar title="Fourier Project Overview.txt" fontFamily={FONT} />
