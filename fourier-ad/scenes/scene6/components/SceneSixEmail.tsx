      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 22, fontWeight: 900, letterSpacing: ".03em" }}>NEW MESSAGE</div>
            <div style={{ marginLeft: "auto", padding: "8px 13px", borderRadius: 999, background: "rgba(255,255,255,.18)", fontSize: 13, fontWeight: 800 }}>3 EFFECTS ATTACHED</div>
          </div>
          ...
          <div style={{ padding: "24px 34px 0", color: "#25213f" }}>
            <div style={{ display: "grid", gridTemplateColumns: "82px 1fr", gap: "12px 4px", paddingBottom: 20, borderBottom: "1px solid #e5e1f2", fontSize: 16 }}>
              <div style={{ color: "#8b84a3", fontWeight: 750 }}>From</div><div style={{ fontWeight: 760 }}>Fourier Agent &lt;agent@fourier.video&gt;</div>
              <div style={{ color: "#8b84a3", fontWeight: 750 }}>To</div><div style={{ fontWeight: 760 }}>AI Launch Team</div>
              <div style={{ color: "#8b84a3", fontWeight: 750 }}>Subject</div><div style={{ fontWeight: 900 }}>Motion effects selected for your AI project</div>
            </div>

            <div style={{ paddingTop: 28 }}>
              <div style={{ color: "#1f1a3d", fontSize: 37, lineHeight: 1.1, fontWeight: 940, letterSpacing: "-.035em" }}>Ready to make your AI launch move.</div>
              <div style={{ marginTop: 13, color: "#79728f", fontSize: 17, lineHeight: 1.55, fontWeight: 600 }}>Three production-ready motion systems, selected and packaged for the next scene.</div>
          ...
          <div style={{ position: "absolute", left: 34, right: 34, bottom: 25, display: "flex", alignItems: "center" }}>
            <div style={{ color: "#9891ad", fontSize: 14, fontWeight: 700 }}>Prepared automatically by Fourier</div>
            <div style={{ marginLeft: "auto", padding: "13px 24px", borderRadius: 14, color: "#fff", background: "#5b4ff2", boxShadow: "0 10px 25px rgba(91,79,242,.25)", fontSize: 15, fontWeight: 900 }}>Send concept →</div>
          </div>
        </motion.div>
      </div>
    </FourierMotion>
