...
const agents = [
  ...
  { label: "Review", cursor: reviewCursorUrl, accent: GOLD, x: 375, y: 627 },
  { label: "Script", cursor: scriptCursorUrl, accent: CORAL, x: 1285, y: 627 },
] as const;
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <AgentLabel label="Video" animated />
            </motion.div>
          </div>
        </World>
      </Universe>
