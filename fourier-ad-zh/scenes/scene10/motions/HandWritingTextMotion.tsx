...
export const handWritingTextMotionSchema = defineSchema({
  fontSize: field.number({
    label: "Font size",
    description: "The handwritten text size in pixels.",
    min: 16,
    max: 340,
    default: 96,
  }),
  fontWeight: field.number({
    label: "Font weight",
    description: "The CSS font weight supported by the typeface.",
    min: 100,
    max: 900,
    integer: true,
    default: 400,
  ...
  letterSpacing: field.number({
    ...
    description: "The spacing between characters in pixels.",
    min: -12,
    max: 40,
    default: 1,
  }),
  lineGap: field.number({
    label: "Line gap",
    description: "The gap between multiple lines, measured in em.",
    min: 0,
    max: 1,
    default: 0.12,
  }),
  inkColor: field.color({
    label: "Ink color",
    description: "The ink color applied after alpha thresholding.",
    default: "#171411",
  }),
  bulge: field.number({
    label: "Bulge variation",
    description: "The turbulent edge displacement applied independently to each character.",
    min: 0,
    max: 6,
    default: 2.2,
  }),
  evolutionSpeed: field.number({
    ...
    description: "The evolution speed of each character's independent noise field, in cycles per second.",
    min: 0.2,
    max: 6,
    default: 1.4,
  }),
  fastBoxBlur: field.number({
    label: "Fast Box Blur",
    description: "The fast softening radius applied before alpha thresholding.",
    min: 0,
    max: 4,
    default: 1.15,
  }),
  alphaThreshold: field.number({
    ...
    description: "The cutoff that sharpens softened alpha back into solid ink.",
    min: 0.05,
    max: 0.95,
    default: 0.42,
  }),
  bevelWidth: field.number({
    label: "Bevel width",
    description: "The softened width of the perspective bevel highlight along each stroke.",
    min: 0.1,
    max: 4,
    default: 0.85,
  }),
  bevelDepth: field.number({
    label: "Bevel depth",
    description: "The depth of the alpha height field; larger values create stronger relief.",
    min: 0,
    max: 12,
    default: 3.2,
  }),
  highlightStrength: field.number({
    ...
    description: "The specular highlight strength composited onto the ink.",
    min: 0,
    max: 2,
    default: 0.46,
  }),
  highlightColor: field.color({
    ...
    description: "The reflection color used to suggest wet or raised ink.",
    default: "#fff3d6",
  }),
  highlightAngle: field.number({
    label: "Highlight angle",
    description: "The horizontal light direction for the perspective highlight, in degrees.",
    min: -180,
    max: 180,
    default: -38,
  }),
